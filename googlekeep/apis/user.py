...
post_parser.add_argument('user_id', required=True, help='유저 고유 ID', location='form')
post_parser.add_argument('user_name', required=True, help='유저 이름', location='form')
post_parser.add_argument('password', required=True, help='유저 패스워드', location='form')
